...
const HomeVenuesection = () => {
  ...
  return (
    <section className="bg-white text-gray-900 py-16 px-10 md:px-12 lg:px-40  mt-10  ">
      {/* Top Content */}
      ...
      >
        <button className="bg-yellow-600 text-white px-6 py-2 rounded-full font-semibold  ">
          Filter Venue List
        </button>
        <select className="px-4 py-2 border rounded-full w-60">
          <option>Select Venue Location</option>
        </select>
        <select className="px-4 py-2 border rounded-full md;w-60">
      ...
      {/* Venue Cards */}
      <motion.div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 lg:mt-30   "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        {visibleVenues.map((venue, index) => (
          <motion.div
            ...
            whileHover={{ scale: 1 }}
          >
            <img src={venue.image} alt={venue.name} className=" h-48 object-cover w-full " />
            <div className="p-4">
              ...
              <div className="flex gap-2 flex-wrap">
                <button className="bg-gradient-to-r from-gray-900 to-yellow-500 hover:from-yellow-600 text-white text-sm px-4 py-2 rounded-full cursor-pointer ">
                  ContactUs
                </button>
      ...
      <div className="flex justify-center mt-10">
        <motion.button
          ...
          className="px-4 py-2 bg-gray-900 text-white rounded-full font-semibold hover:bg-gray-700 transition-color mt-15"
          whileTap={{ scale: 0.95 }}
