...
import { Link } from 'react-router-dom'
    ...
    return (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 animate-rise-up mt-50">
            ...
            <Link to="/contactus" className="bg-gradient-to-r from-gray-900 to-yellow-500 text-white px-4 py-2 rounded-full hover:from-yellow-600 transition cursor-pointer ">
                Contact us
            </Link>
            </div>
        </div>
