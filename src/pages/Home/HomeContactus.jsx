...
function HomeContactus() {
  return (
    <div className="relative flex items-center justify-center  bg-black/70 ">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center bg-fixed animate-zoom z-[-1] overflow-hidden"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <form className="bg-white bg-opacity-20 backdrop-blur-sm p-4 sm:p-6 md:p-8 rounded-lg space-y-4 border border-white/30">
  <input
    type="text"
    placeholder="Enter your Full Name"
    className="w-full px-4 py-2 rounded bg-white/90 text-black text-sm sm:text-base focus:outline-none border-2 border-gray-400"
  />
  <input
    type="text"
    placeholder="Enter your Phone Number"
  ...
  <button
    type="submit"
    className=" bg-gray-700 hover:bg-gray-800 text-white px-6 py-2 rounded-full text-sm sm:text-base"
  >
    SUBMIT
  </button>
</form>
