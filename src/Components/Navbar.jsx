...
//               <p>
//                 <strong>JS Event Management</strong> is an ISO 9001:2008
//                 Certified Company based in Kochi, Thrissur Kerala. We offer
//                 premium event management services including weddings, corporate
...
export default function Navbar() {
  ...
  return (
    <header
      className={`${
        scrolled ? "bg-gray-900" : "bg-transparent px-4 py-6 md:py-5 lg:py-3"
      } text-white overflow-hidden fixed top-0 left-0 z-50 w-full transition-all duration-100`}
    >
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        {/* Logo */}
        <div className="w-20 sm:w-24 md:w-[120px]">
        ...
        <div className="hidden md:flex flex-1 items-center justify-end space-x-4 lg:space-x-6 xl:space-x-8">
          <nav className="flex space-x-4 sm:space-x-5 md:space-x-6 text-sm md:text-sm font-semibold">
            <Link
              to="/home"
              className={`hover:text-yellow-400 ${
                location.pathname === "/home" ? "text-yellow-400" : "text-white"
              }`}
            >
              HOME
            </Link>
            ...
            <Link
              to="/services"
              className={`hover:text-yellow-400 ${
                location.pathname === "/services" ? "text-yellow-400" : "text-white"
              }`}
            >
              SERVICES
            </Link>
            <Link
              to="/blog"
              className={`hover:text-yellow-400 ${
                location.pathname === "/blog" ? "text-yellow-400" : "text-white"
              }`}
            >
              BLOG
            </Link>
            <Link
              to="/gallery"
              className={`hover:text-yellow-400 ${
                location.pathname === "/gallery" ? "text-yellow-400" : "text-white"
              }`}
            >
              GALLERY
            </Link>
      ...
      <AnimatePresence>
        {isInfoPanelOpen && (
          ...
          >
            ...
            <div className="text-sm md:text-base leading-relaxed space-y-6">
              <div className="w-20 sm:w-24 md:w-[70px]">
          <img src={js} alt="logo" className="w-full h-auto" />
        </div>
              <p>
                <strong>JS Event Management</strong> is an ISO 9001:2008
