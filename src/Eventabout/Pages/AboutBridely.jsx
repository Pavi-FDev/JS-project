...
const Counter = ({ target }) => {
  ...
  useEffect(() => {
    ...
    const duration = 3000; // 3 minutues
  ...
  return (
    <section className="bg-yellow-100 py-16 px-4 lg:px-60   ">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-2xl mx-auto bg-gray-900 text-white mt-20 lg:rounded-tr-full lg:rounded-bl-full py-10 px-6 flex flex-col md:flex-row justify-around items-center gap-6 shadow-md "
      >
        {[
          [1565, 'Happy Couples'],
          [1680, 'Weddings'],
